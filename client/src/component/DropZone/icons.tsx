...
export const DropZoneIcon = ():JSX.Element => (
  <svg aria-label="Icon to represent media such as images or videos" className="drop-zone-icon" color="#262626" fill="#262626" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
